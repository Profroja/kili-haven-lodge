const FloatingSocialButtons = () => {
  const handleWhatsApp = () => {
    window.open('https://wa.me/255676626193', '_blank');
  };

  const handleInstagram = () => {
    window.open('https://instagram.com/kilihaven', '_blank');
  };

  const handleCall = () => {
    window.open('tel:+255676626193', '_self');
  };

  const handleEmail = () => {
    window.open('mailto:kilihavenlodge@gmail.com', '_self');
  };
  ...
  return (
    <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50 flex flex-col gap-3">
      ...
      <button
        ...
        title="Email kilihavenlodge@gmail.com"
      >
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
